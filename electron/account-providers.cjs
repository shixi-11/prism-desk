...
const providers=Object.freeze({
 ...
 Claude:{provider:'Claude',executable:'claude.exe',model:'opus',write:true,installUrl:'https://code.claude.com/docs/en/setup',loginArgs:p=>['auth','login','--claudeai',...(p.email?['--email',p.email]:[])],authHosts:['claude.ai','claude.com'],authPath:/^\/oauth\/authorize$/},
