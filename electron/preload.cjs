...
const capabilityMethods = ['mcpList','mcpChange','mcpCancel','inspectCapabilities', 'syncCapabilities', 'importInstalledPlugins', 'automaticPlugins', 'addCapabilitySource', 'removeCapabilitySource', 'openCapabilitySource'];
