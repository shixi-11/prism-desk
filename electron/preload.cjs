...
const methods = ['accounts','saveAccount','enableAccount','verifyAccount','accountInstall','pickAccountFile','startAccountLogin','openAccountLogin','cancelAccountLogin','taskMenu','taskAction','preferences','cancelQueued','retryQueued','addImages','imageThumbnail','preview','savePreview','defaultMode','validateApps','loginGemini','openTaskStorage','stopAndContinue','language','resetCredit','models','modelSettings','init','task','create','pickDirectory','theme','scan','quota','run','switch','stop','approve','update','reconcile','openWorkspace','export'];
