...
const capabilityMethods = ['mcpCopyLogin','mcpList','mcpChange','mcpCancel','inspectCapabilities', 'syncCapabilities', 'importInstalledPlugins', 'automaticPlugins', 'addCapabilitySource', 'removeCapabilitySource', 'openCapabilitySource'];
const methods = ['goalAction','answerQuestion','removeAccount','renameProject','projectMenu','projectAction','createProject','renameAccount','savePlan','planAction','relayPreferences','authorHomepage','projectRepository','accounts','saveAccount','enableAccount','verifyAccount','accountInstall','pickAccountFile','startAccountLogin','copyAccountLogin','submitAccountLoginCode','cancelAccountLogin','taskMenu','taskAction','preferences','cancelQueued','sendQueued','retryQueued','addImages','imageThumbnail','preview','openPreview','savePreview','defaultMode','validateApps','loginGemini','openTaskStorage','stopAndContinue','language','resetCredit','models','modelSettings','init','task','create','pickDirectory','theme','scan','quota','run','switch','stop','approve','update','reconcile','openWorkspace','export'];
