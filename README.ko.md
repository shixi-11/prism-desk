...
서로 다른 대화는 동시에 실행할 수 있습니다. 쓰기가 포함되고 작업 디렉터리가 겹치는 작업은 순서대로 실행됩니다. 중지와 지시는 해당 대화에만 적용되며, 대기 중인 대화에서 선택한 계정은 즉시 저장됩니다.
...
다음 명령은 안정 버전 **v0.1.26**을 설치합니다. [최신 릴리스](https://github.com/shixi-11/prism-desk/releases/latest)에서 버전과 두 언어로 제공되는 변경 사항을 확인하세요.
