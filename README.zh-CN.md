...
**仅限非商业用途。** 源码按[棱镜非商业使用许可证](LICENSE)提供；未经著作权人另行书面授权，禁止商用。
...
以下命令安装稳定版 **v0.1.30**。[最新发布页](https://github.com/shixi-11/prism-desk/releases/latest)提供版本号与中英文更新内容。
...
**仅限非商业用途。** 源码按[棱镜非商业使用许可证](LICENSE)提供；未经著作权人另行书面授权，禁止商用。棱镜是独立项目，各提供方名称与商标归其所有者所有。
