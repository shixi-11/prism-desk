...
export default function SidebarTasks({tasks,renderTask,projectNames={},onRenameProject}){
 ...
 const [collapsed,setCollapsed]=useState(()=>{try{return {pinned:true,projects:true,recent:true,...JSON.parse(localStorage.getItem('prism-sidebar-folds')||'{}')};}catch{return {recent:true};}});
