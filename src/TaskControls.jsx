...
export function AccountQuota({profile,quota}){
 ...
 const stale=quota?.cached||quota?.checkedAt&&(now-Date.parse(quota.checkedAt)>300000||quota.windows?.some(w=>w.resetsAt&&w.resetsAt*1000<=now));
